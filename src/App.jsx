...
const ORGANIZER_WHATSAPP = "2348067535437"; // no + or leading zeros, digits only
...
export default function PremiumRegistration() {
  ...
  function copyAccount() {
    const text = "Wema Bank Plc\nLarge Integrated Services Global Hub Ltd\n5272391585";
  ...
  return (
    <div style={{ background: COLORS.forestDeep, fontFamily: "'Inter', sans-serif" }} className="min-h-screen">
      ...
      {/* HERO */}
      <div className="relative overflow-hidden px-6 pt-14 pb-10 md:px-16">
        <div
        ...
        <h1
          style={{ fontFamily: "'Fraunces', serif", color: "#fff", fontSize: "clamp(32px,5vw,52px)", lineHeight: 1.05 }}
          ...
          {step === "payment" && (
            <>
              ...
              <div className="rounded-lg p-4 mb-5" style={{ background: COLORS.forest }}>
                ...
                <p style={{ color: "#eee" }}>Bank: Wema Bank Plc</p>
                <p style={{ color: "#eee" }}>Account name: Large Integrated Services Global Hub Ltd</p>
                <p style={{ color: "#eee" }}>Account number: 5272391585</p>
